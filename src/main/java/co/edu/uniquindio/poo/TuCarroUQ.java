...
public class TuCarroUQ {
    ...
    public void listarInformacion() {
        ...
        for (Vehiculo vehiculo : vehiculos) {
            System.out.println(vehiculo); // Usar toString() de Vehiculo
        }
    
        System.out.println("\nInformación de Clientes:");
        for (Cliente cliente : clientes) {
            System.out.println(cliente); // Usar toString() de Cliente
        }
    
        System.out.println("\nInformación de Transacciones:");
        for (Transaccion transaccion : transacciones) {
            System.out.println(transaccion); // Usar toString() de Transaccion
        }
    }
    ...
    private void registrarVehiculo(Scanner scanner) {
        ...
        String esNuevo = scanner.nextLine();
